# TKOS Write-Path Sidecar — Scope v0.3.1

**Date:** 2026-06-05 (v0.2 locked) → 2026-06-06 (v0.2.1 first audit response) → 2026-06-06 (v0.3.1 second audit response, this version).
**Status:** LOCKED at v0.3.1 — implementation-ready at executable-contract level. Supersedes v0.2.1.
...
**Concurrency:** v0.3.1 assumes single-writer per session. Multiple sessions can ingest in parallel; same-session interleaving is not in scope.
